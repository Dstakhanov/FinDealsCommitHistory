...
class InstrumentItemListAdapter :
    ListAdapter<com.dstakhanov.item.domain.InstrumentItem, InstrumentItemViewHolder>(
        InstrumentItemDiffCallback()
    ) {

    var onInstrumentItemLongClickListener: ((com.dstakhanov.item.domain.InstrumentItem) -> Unit)? = null
    var onInstrumentItemClickListener: ((com.dstakhanov.item.domain.InstrumentItem) -> Unit)? = null
